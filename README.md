...
* MAIN TESTING 
  * add necessary API KEYS to env file 
  * fire up openclaw
  * do mcp tasks via openclaw chat against smmt target accounts 
  * test all accounts

* add python tool that does video splice (blocked my michael refactor)

* research if we needf to include additional MCP tools 

* add REMOTION and EXCALIDRAW functionalty to docs and config 

* revise + research for additonal MCPs / better ones with better funcitonality
  * DOCUMENT EVERYTHING

* HAPPY TRAILS WITH THE GTM + CONTENT CREATION
